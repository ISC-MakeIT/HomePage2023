import { apiEditNotification, type GetResponse, type PutResponse } from '@api/admin/notifications';
import { apiNotification, type Notification } from '@api/admin/notifications/notification';
...
interface EditNotificationModalContainerProps {
